...
<head>
	...
	<script>
		...
		function statusClick() {
			...
			if(document.iu_form.indate.value.length == 0){
				inD.checked = true;
			}else{
				outD.checked = true;
			}
		}
		function indateChange(i) {
			var inD = document.getElementById("inD");
			var outD = document.getElementById("outD");
		...
		<form name="iu_form" method="post" action="reservation0127_insert.jsp">
			<table id="iu_table">
				...
				<tr>
					...
					<th>반납일자</th>
					<td><input type="text" name="indate" value="<%=indate %>"  maxlength="10" onchange="indateChange(this)"></td>
				</tr>
				<tr>
					<th>대출상태</th>
					<td>
